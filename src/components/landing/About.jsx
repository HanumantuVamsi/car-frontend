    ...
    <div id='about' className="py-12 bg-gradient-to-r from-red-600 to-black">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-white">
          ...
          <Carousel showArrows={true} autoPlay={true} infiniteLoop={true} showThumbs={false} showStatus={false} centerMode={true} centerSlidePercentage={50}>
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg mx-2">
