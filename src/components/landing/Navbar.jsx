...
const Navbar = () => {
  ...
  return (
    <div id='home' className=' sticky top-0 w-full bg-gradient-to-r from-black to-red-600'>
      <div className='flex items-center p-4 justify-between shadow-md'>
        <div>
          <Link to="/"><h1 className='lg:text-3xl md:text-2xl text-gray-200 font-bold'>DriveSwift</h1></Link>  
        </div>
